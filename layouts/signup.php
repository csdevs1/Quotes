            ...
            <div class="modal-body" role="form">
                ...
                <div class="col-xs-12">
                    <label class="agreed-terms">
                        <input type="checkbox" id="terms"> <span>I agree with the <a href="/about/terms-service" target="_blank">Terms of Service</a> and <a href="/about/privacy-policies" target="_blank">Privacy Policies</a></span>
                    </label>
                </div>
            </div>
