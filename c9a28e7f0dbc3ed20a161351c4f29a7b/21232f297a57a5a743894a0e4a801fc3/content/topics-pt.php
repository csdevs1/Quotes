    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-xs-6">
                        <button type="button" class="btn btn-warning" onclick="addTextBox('image-box')"><span class="glyphicon glyphicon-plus"></span> Adicionar uma imagem</button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container quote-form" id="update-form">
    <div class="row">
        ...
        <div class="form-group col-xs-12">
            <div class="input-group">
                <span class="input-group-addon"><i class="ion-person"></i></span>
                <input type="text" class="form-control" id="topic-up" data-error="Field required" aria-describedby="topic" placeholder="Digite tópico..."  oninput="checkAvailability(this)">
        ...
        <div class="form-group col-xs-12">
            <div class="input-group">
                <span class="input-group-addon"><i class="ion-person"></i></span>
                <input type="text" class="form-control" id="keywords-up" data-error="Field required" aria-describedby="topic" placeholder="Keywords separados por vírgulas...">
    ...
    var openUpdate=function(topID){
        ...
        topic.done(function(data){
            if(Object.keys(data[0][0]).length > 1){
                ...
                $('#topic-up').focus();
                var topicRel = find_by('topics','tPT_id',topID);
                                            ...
                                            image.done(function(img){
                                                ...
                                                token3.done(function(generatedToken3){
                                                    ...
                                                    insertImages.done(function(){
                                                        ...
                                                        console.log('Done!');
                                                        setTimeout(function() {
                                                            topics('Topic Saved correctly',document.getElementById('topic-pt'));
                                                        }, 2000);
                                                    });
                                                });
                                            });
