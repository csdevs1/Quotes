    ...
    <div class="row" id="row">
        ...
        <?php
            foreach($authors as $key=>$val){
                ...
                if(empty($authors[$key]['authorName']) || empty($authors[$key]['sourceURL']) || empty($authors[$key]['birth']) || empty($professions) || empty($authors[$key]['nationality']) || empty($authors[$key]['seo_url'])){
        ?>
