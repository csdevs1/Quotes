...
<div class="portlet-heading">
    ...
    <div class="col-lg-12 text-dark"><span id="add-quote" onclick="openWindow(this)"><span class="glyphicon glyphicon-edit"></span> Adicionar uma nova cotação</span></div>
</div>
    ...
    var updateQuote = function(el, quotID){
        ...
        if(!quote || quote==''){
            ...
            token.done(function(generatedToken){
                var quoteUpdate = update('quotes_pt',arr,'quoteID',quotID,generatedToken);
